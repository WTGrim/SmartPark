...
/**
 默认滚动到当前时间
 */
-(instancetype)initWithDateStyle:(DateStyle)datePickerStyle CompleteBlock:(void(^)(NSDate *))completeBlock {
    self = [super init];
    if (self) {
...
-(void)setupUI {
    ...
    self.ensureBtn.layer.borderColor = RGB(65, 188, 241).CGColor;
    self.ensureBtn.layer.borderWidth = 1.0;
    
    self.cancelBtn.layer.borderColor = RGB(65, 188, 241).CGColor;
